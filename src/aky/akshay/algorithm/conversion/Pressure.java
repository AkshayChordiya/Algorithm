...
public class Pressure extends Activity {
	...
	boolean atm = false, bar = false, pascal = false, torr = false, psi = false;
	
	// List Items
	String items[] = {"Atmosphere" , "Bar" , "Pascal" , "Torr" , "PSI"};
	
	// Integer Constants for LIST item
	public static final int Atm = 0;
	public static final int Bar = 1;
	public static final int Pascal = 2;
	public static final int Torr = 3;
	public static final int PSI = 4;
	
	public static final int SametoSame = 99;
	
	// Integer Constants for CONVERSION
	public static final int AtmtoBar = 0;
	public static final int AtmtoPascal = 1;
	public static final int AtmtoTorr = 2;
	public static final int AtmtoPSI = 3;
	public static final int BartoAtm = 4;
	public static final int BartoPascal = 5;
	public static final int BartoTorr = 6;
	public static final int BartoPSI = 7;
	public static final int PascaltoAtm = 8;
	public static final int PascaltoBar = 9;
	public static final int PascaltoTorr = 10;
	public static final int PascaltoPSI = 11;
	public static final int TorrtoAtm = 12;
	public static final int TorrtoBar = 13;
	public static final int TorrtoPascal = 14;
	public static final int TorrtoPSI = 15;	
	public static final int PSItoAtm = 16;
	public static final int PSItoBar = 17;
	public static final int PSItoTorr = 18;
	public static final int PSItoPascal = 19;
		...
		base.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> parent, View view, int position,
				...
				case Atm:
					...
					atm = true;
					Toast.makeText(getBaseContext(), "Atmosphere Selected", Toast.LENGTH_SHORT).show();
				...
				case Bar:
					// Setting corresponding boolean & message
					bar = true;
					Toast.makeText(getBaseContext(), "Bar Selected", Toast.LENGTH_SHORT).show();
					// Setting others false
					atm = false;
					pascal = false;
					torr = false;
				...
				case Pascal:
					// Setting corresponding boolean & message
					pascal = true;
					Toast.makeText(getBaseContext(), "Pascal Selected", Toast.LENGTH_SHORT).show();
					// Setting others false
					atm = false;
					pascal = false;
					bar = false;
				...
				case Torr:
					// Setting corresponding boolean & message
					torr = true;
					Toast.makeText(getBaseContext(), "Torr Selected", Toast.LENGTH_SHORT).show();
					// Setting others false
					atm = false;
					bar = false;
					pascal = false;
				...
				case PSI:
					// Setting corresponding boolean & message
					psi = true;
					Toast.makeText(getBaseContext(), "PSI Selected", Toast.LENGTH_SHORT).show();
					// Setting others false
					atm = false;
					bar = false;
					pascal = false;
