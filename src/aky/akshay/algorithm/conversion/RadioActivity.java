...
public class RadioActivity extends Activity {
	...
	boolean becquerel = false , curie = false , di = false;
	
	// List Items
	String items[] = {"Becquerel" , "Curie" , "Disintegration/Min"};
	
	// Integer Constants for LIST item
	public static final int Becquerel = 0;
	public static final int Curie = 1;
	public static final int DM = 2;
	
	public static final int SametoSame = 99;
	
	// Integer Constants for CONVERSION
	public static final int BecquereltoCurie = 0;
	public static final int BecquereltoDM = 1;
	public static final int CurietoBecquerel = 3;
	public static final int CurietoDM = 4;
	public static final int DMtoBecquerel = 5;
	public static final int DMtoCurie = 6;
	...
	private void setupListView() {
		...
		base.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> parent, View view, int position,
				...
				case Becquerel:
					...
					becquerel = true;
					Toast.makeText(getBaseContext(), "Becquerel Selected", Toast.LENGTH_SHORT).show();
				...
				case Curie:
					// Setting corresponding boolean & message
					curie = true;
					Toast.makeText(getBaseContext(), "Curie Selected", Toast.LENGTH_SHORT).show();
					// Setting others false
					becquerel = false;
					di = false;
					break;
				case DM:
					// Setting corresponding boolean & message
					di = true;
					Toast.makeText(getBaseContext(), "DisIntegration/Min Selected", Toast.LENGTH_SHORT).show();
					// Setting others false
					becquerel = false;
					curie = false;
					break;	
		...
		convert.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> parent, View view, int position,
				...
				// Generating code for each position
				switch(position){    
				case BecquereltoCurie:
					break;
				case BecquereltoDM:
					break;
				case CurietoBecquerel:
					break;
				case CurietoDM:
					break;
				case DMtoBecquerel:
