...
public class Time extends Activity {
	...
	boolean dentury = false , day = false , decade = false , hour = false ,
			minute = false , month = false , second = false;	
	
	// List Items
	String items[] = {"Century" , "Day" , "Decade" , "Hour" , "Minute"  , "Month" , "Second"};
	
	// Integer Constants for LIST item
	public static final int Century = 0;
	public static final int Day = 1;
	public static final int Decade = 2;
